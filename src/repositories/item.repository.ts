...
> {
  ...
  constructor(
    @inject('datasources.dbSource') dataSource: DbSourceDataSource, @repository.getter('ItemListRepository') protected itemListRepositoryGetter: Getter<ItemListRepository>,
  ) {
